    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                ...
                <form role="form" action="{{ route('porcats.update',$porcats->id) }}" method="post"
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <input
                                        value="@if (old('name_ar')){{ old('name_ar') }}@else{{ $porcats->name_ar }}@endif"
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <input
                                        value="@if (old('name_en')){{ old('name_en') }}@else{{ $porcats->name_en }}@endif"
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <input
                                        value="@if (old('name_tr')){{ old('name_tr') }}@else{{ $porcats->name_tr }}@endif"
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <input value="@if (old('slug')){{ old('slug') }}@else{{ $porcats->slug }}@endif"
                    ...
                    <div class="box-footer">
                        ...
                        <a type="button" class="btn btn-warning"
                            href="{{   route('porcats.index')   }}">{{ trans('backend.back') }}</a>
                    </div>
