<title>{{ GeneralSiteSettings("site_title_" . trans('backend.boxCode')) . " | "  . ucfirst(Request::segment(2)) }}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
<meta name="description" content="{{ GeneralSiteSettings("site_meta_description_" . trans('backend.boxCode'))}}">
<meta name="keywords"   content="{{ GeneralSiteSettings("site_meta_keywords_" . trans('backend.boxCode'))}}">
<meta name="author" content="{{ GeneralSiteSettings("site_title_" . trans('backend.boxCode'))}}">

<link rel="icon" href="{{ URL('uploads/settings/'. GeneralSiteSettings("site_icon_" . trans('backend.boxCode')))}}" type="image/x-icon">
<!-- VENDOR CSS -->
