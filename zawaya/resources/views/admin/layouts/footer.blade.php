...
<script src="{{asset('backend/assets/vendor/multi-select/js/jquery.multi-select.js') }}"></script><!-- Multi Select Plugin Js -->
...
<script src="{{asset('backend/html/assets/js/pages/forms/editors.js') }}"></script>
