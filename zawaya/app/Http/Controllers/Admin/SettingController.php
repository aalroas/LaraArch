...
// icon icin
            ...
            if ($fileFinalName != "") {
                ...
                unlink($this->getUploadPath() . $Setting->site_logo_ar);
                $Setting->site_logo_ar = $fileFinalName;
            }

              if ($fileFinalNameEn != "") {
                unlink($this->getUploadPath() . $Setting->site_logo_en);
                $Setting->site_logo_en = $fileFinalNameEn;
            }

             if ($fileFinalNameTr != "") {
                unlink($this->getUploadPath() . $Setting->site_logo_tr);
                $Setting->site_logo_tr = $fileFinalNameTr;
            }


            if ($fileIconFinalName != "") {
                unlink($this->getUploadPath() . $Setting->site_icon_ar);
                $Setting->site_icon_ar = $fileIconFinalName;
            }

              if ($fileIconFinalNameEn != "") {
                unlink($this->getUploadPath() . $Setting->site_icon_en);
                $Setting->site_icon_en = $fileIconFinalNameEn;
            }

             if ($fileIconFinalNameTr != "") {
                unlink($this->getUploadPath() . $Setting->site_icon_tr);
